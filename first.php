...
<div class="mdl-layout mdl-js-layout">
  ...
  <main class="mdl-layout__content">
	...
	<form>
  <button formaction="main1.php"   style="height:200px;width:200px">Add a Product</button>
</form>

	<form>
  <button formaction="status.php"  style="height:200px;width:200px" >changestatus</button>
</form>
